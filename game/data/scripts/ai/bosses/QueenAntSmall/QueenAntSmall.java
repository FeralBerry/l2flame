 ...
 */
package ai.bosses.QueenAntSmall;
 ...
 * @author Emperorc
 */
public class QueenAntSmall extends AbstractNpcAI
{
	...
	private QueenAntSmall()
	{
		...
		{
			final GrandBoss queen = (GrandBoss) addSpawn(QUEEN, QUEEN_X, QUEEN_Y, QUEEN_Z, 0, false, 0);
			queen.setCurrentHpMp(queen.getMaxHp(), queen.getMaxMp());
			spawnBoss(queen);
		}
	}
